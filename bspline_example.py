...
def compare3methods(P, T, X, max_iter=100):
    ...
    optimized_control_points_PD, tot_iter_PD, avg_error_PD = gradient_descent_PD(P, T, knots, degree, X, max_iter=max_iter, constraint=True)
    ...
    optimized_control_points_TD, tot_iter_TD, avg_error_TD = gradient_descent_TD(P, T, knots, degree, X, max_iter=max_iter, constraint=True)
    ...
    optimized_control_points_SD, tot_iter_SD, avg_error_SD = gradient_descent_SD(P, T, knots, degree, X, max_iter=max_iter, constraint=True)
...
if __name__ == "__main__":
    ...
    #visualize_points(X)
    #Pc = np.array([ [0.0, 0.0], [-0.5, 1.5], [0.5, 1.0], [1.5, 1.5], [1.0, 0.0]])
